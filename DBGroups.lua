...
DBGroups['Dialogue'] = {
	'Saluer','Acquiescer','Refuser','Interjecter','Questionner','Demander','Repondre','S\'excuser', 'Feliciter','S\'exclafer',
	'Rire', 'Se Moquer', 'Se Plaindre','Hurler','Silencier','Insulter','Quitter'
	};
