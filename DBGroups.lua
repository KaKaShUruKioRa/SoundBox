...
DBGroups['Dialogue'] = {
	'Saluer','Acquiescer','Refuser','Interjecter','Questionner','Demander','Repondre','S\'excuser', 'Feliciter','S\'exclafer','Rire',
	'Se Plaindre','Hurler','Silencier','Insulter','Quitter'
	};
...
DBGroups['Par License'] = {
	...
	'Jojo\'s', 
	'Les Kassos','Palmashow', 
	'Dexter', 'Kaamelott',
	'Star Wars'};
DBGroups['Par Duree'] = {'Tres Court', 'Court', 'Moyen', 'Long', 'Tres Long' };
DBGroups['Fav Membres'] = {'Amecareth', 'Balko', 'Musha', 'Corypheo', 'Hixday', 'Arzatoth', 'Chichi', 'Jaizu', 'Gramark', 'KaKaShUruKioRa'}
